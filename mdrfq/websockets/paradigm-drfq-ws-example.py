...
Usage:
    python3.9 paradigm-drfq-ws-example.py
...
if __name__ == "__main__":
    ...
    # ws_connection_url: str = 'wss://ws.api.chat.paradigm.co'
    # Paradigm TEST WebSocket Connection URL
    ws_connection_url: str = 'wss://ws.api.test.paradigm.co'

    # DRFQ Version + Product URL
    ws_connection_url += '/v1/drfq'
