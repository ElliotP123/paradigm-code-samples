...
Usage:
    python3.9 paradigm-fspd-ws-example.py
    ...
    async def ws_manager(self) -> None:
        async with websockets.connect(
            ...
            self.loop.create_task(
                self.ws_operation(
                    operation='subscribe',
                    ws_channel='trade_tape.ALL.ALL.ALL'
                    )
                )
...
if __name__ == "__main__":
    ...
    # ws_connection_url: str = 'wss://ws.api.fs.chat.paradigm.co'
    # Paradigm TEST WebSocket Connection URL
    ws_connection_url: str = 'wss://ws.api.fs.test.paradigm.co'

    # FSPD Version + Product URL
    ws_connection_url += '/v1/fs'
